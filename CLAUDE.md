...
2. **Toda empresa cede al menos una Cesión válida a la semana** (D-010, parámetros fijados en D-044 · Norma 1 del fundador). Pertenecer a NS es contribuir. Escalera: la segunda semana sin ceder, primer aviso con diplomacia; la tercera, segundo aviso tajante con la Directiva al tanto; la cuarta, suspensión de la titularidad en NS Network. El agente de cada empresa trabaja para que su miembro lo cumpla sin esfuerzo.
