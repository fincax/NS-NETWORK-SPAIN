...
| [`docs/17_DESPLIEGUE.md`](./docs/17_DESPLIEGUE.md) | Cuándo y cómo pasar al servidor: entorno privado de demostración ahora, producción con empresas reales tras la puerta de Fase 1. Paso a paso para Vercel (§4) y para un servidor propio en Clouding con `deploy/instalar.sh` (§4c). |
