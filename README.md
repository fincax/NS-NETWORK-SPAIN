...
| [`docs/18_REGLAMENTO.md`](./docs/18_REGLAMENTO.md) | Reglamento: Normas de obligado cumplimiento para todos los titulares y Ventajas para los destacados, con estados, mecanismo, consecuencia y verificación. Canal del fundador para añadir normas en el tiempo (D-043). |
