...
export async function currentMember() {
  ...
  if (authMode() === "real") {
    // Cuenta personal (D-042): la sesión decide quién eres; nunca el selector.
...
/** Comprueba el acceso (D-033 demo / D-042 cuentas). El proxy ya lo exige, pero las Server Functions no deben fiarse solo de él. */
