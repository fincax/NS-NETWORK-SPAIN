...
**Status:** CONFIRMED por el fundador el 2026-09-14 en su totalidad (concepto, nombres Eco · Aval · Dar la Palabra, pesos y umbrales propuestos), con un matiz: **el Aval se muestra en la web pública**, y de cada Eco solo el nombre y apellido (o el nombre de empresa) que eligió el Interesado y su valoración, **sin datos de contacto**.
**Date:** 2026-09-14
...
- **Aval en la web pública (matiz del fundador).** Cada titular tiene una página pública (`/aval/[slug]`, fuera de la puerta de la demo) con su nombre, especialidad y Sala, su Aval con los cuatro bloques y los Ecos publicados con consentimiento. De cada Eco se muestra únicamente el nombre que el Interesado eligió (nombre y apellido o nombre de empresa), su valoración y su línea. **Nunca datos de contacto** de nadie: ni correo, ni teléfono, ni web, ni el nombre del Timonel, ni identificadores internos. El consentimiento del Interesado nombra expresamente esa página. El Dossier enlaza a ella.
