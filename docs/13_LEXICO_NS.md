...
| **Aval** | El número público (0–100) que respalda una Cesión y, agregado, a cada titular. En la Cesión nace de Promesa, Veredicto y Eco (25 · 35 · 40). En el titular tiene cuatro bloques explicados: Voz de los Interesados, Calidad de lo que cede, Respuesta y Contribución. Da elegibilidad de Embajadora y prioridad en la Mesa. Se muestra en la web pública con el nombre de la empresa y, de cada Eco, el nombre elegido por el Interesado y su valoración, sin datos de contacto. Nunca un ranking; sin histórico vale lo neutro y lo dice (D-042). | `Referral.aval`, `TitularAval`, `/aval/[slug]` |
...
| **Compromiso** | Una Cesión válida a la semana, a quien corresponda (D-010, D-044 · Norma 1 del fundador). Escalera: empujón, primer aviso, segundo aviso, suspensión de la titularidad en la cuarta semana. | `compromiso_weeks_without`, `compromiso_level` |
| **Titularidad suspendida** | Estado de la empresa, su plaza y su Agente tras la cuarta semana sin Cesión válida. La Sala lo ve; la Mesa deja de proponer a ese titular. Reincorporación: protocolo pendiente. | `status: SUSPENDED` |
