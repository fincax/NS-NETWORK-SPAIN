...
| **Directiva** | Quien dirige la Sala: despacha la Antesala, revisa las excepciones, propone bajas a NS, promueve acciones entre Salas y resuelve dudas entre Timoneles, lo que le suma Valoración (D-048). No existe la figura "Director/a de Sala" (D-061). Composición, elección y mandato, pendientes. | `Member{ is_director }` | "La Directiva revisa las excepciones." |
...
| **Valoración** | Porcentaje mensual y explicable de cada titular en su Sala: calidad de lo cedido (Veredictos), Compromiso, plazo de respuesta, Comunicado y servicio a la red. Nunca mide cantidad. Con ≥ 80 % en el último mes completo, apta para Embajada (D-046). | `MonthlyRating` |
...
| **Manantial** | Un Timonel, un titular, que por su condición de empresa o de profesión es propicio desde el inicio para facilitar multitud de referidos de sectores distintos. Es una condición de la titularidad, no una especialidad concreta: administración de fincas, asesoría fiscal, seguros o arquitectura son solo ejemplos. Mismas reglas que todo titular: plaza, Normas, cuota, Compromiso, Balanza. NS-CAT marca las especialidades Manantial, la Antesala las prioriza y la Hoja de Méritos reconoce la amplitud de lo cedido, nunca la cantidad. No es un rol: no existe miembro sin plaza (D-059). No confundir con "Fuente propia" ni con las fuentes públicas del Rastreo. | `Specialty{ manantial }` | "NS Cumbre tiene tres Manantiales." "Administración de fincas es especialidad Manantial." |
...
| **Ejercicio** | El año natural, de enero a diciembre (D-062): periodo en que NS revisa el Tramo de cuota y cuenta las Embajadas. El primero de cada empresa va desde su alta hasta el 31 de diciembre. El Compromiso se mide por semana y la Valoración por mes. | `Period` |
...
| **Cuota** | El precio de la suscripción a NS: lo que paga una empresa a NS por su plaza y su Agente. Cuota inicial y cuota mensual por Tramos, las dos muy bajas; los importes los anuncia NS (D-063). Son los ingresos de NS. Es un plano distinto de la regla entre miembros: nunca es un porcentaje del negocio ni un cargo por Cesión (D-005, D-025). | `MembershipPlan` |
