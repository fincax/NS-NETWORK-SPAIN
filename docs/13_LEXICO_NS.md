...
| **Manantial** | Condición de una titularidad cuya especialidad ve necesidades de muchos sectores (administración de fincas, asesoría fiscal, seguros, arquitectura). Mismas reglas que todo titular: plaza, Normas, cuota, Compromiso, Balanza. NS-CAT marca las especialidades Manantial, la Antesala las prioriza y la Hoja de Méritos reconoce la amplitud de lo cedido, nunca la cantidad. No es un rol: no existe miembro sin plaza (D-059). No confundir con "Fuente propia" ni con las fuentes públicas del Rastreo. | `Specialty{ manantial }` | "NS Cumbre tiene tres Manantiales." "Administración de fincas es especialidad Manantial." |
