...
- Responsable: `NS Network Spain`, contacto `NS_CONTACT_EMAIL` (por defecto `privacidad@networkspain.com`). Razón social, NIF y domicilio quedan pendientes del fundador.
...
1. **Identidad del responsable**: razón social, NIF, domicilio; buzón `privacidad@networkspain.com` operativo o `NS_CONTACT_EMAIL` fijado.
