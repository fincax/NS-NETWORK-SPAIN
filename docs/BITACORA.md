...
- **Misma mañana, después:** `docs/18_GUIA_DEL_TIMONEL.md`, guía de uso para candidatos y nuevos titulares, publicada además como página compartible para enviar a empresarios. Cuando cambien las Normas, la cuota o el flujo de entrada, se actualiza aquí primero.
