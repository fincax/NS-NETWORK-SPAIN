...
5. Copias de seguridad de PostgreSQL del servidor con restauración probada (hoy no hay ninguna). Después: resto de `docs/08` con el abogado, Protocolo II (Comunicado y Gaceta) y Brújula.
