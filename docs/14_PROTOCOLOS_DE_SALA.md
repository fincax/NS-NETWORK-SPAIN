...
- **Escalera** por semanas seguidas sin ceder: 1.ª constancia; 2.ª aviso diplomático del Agente; 3.ª aviso formal de la Directiva para aportar lo antes posible; 4.ª notificación de baja de la titularidad. La empresa queda suspendida y la Directiva ejecuta la baja desde la Antesala; la plaza vuelve a la Antesala. Una Cesión válida pone la cuenta a cero.
