...
| --- | --- | --- | --- |
| 1 | **Usuarios con contraseña y permisos por Sala** | Hecho (D-042): cuentas personales con `NS_AUTH_MODE=real`, sesiones visibles, enlaces de acceso de un solo uso y registro de accesos. Falta el envío de correos de invitación. | Hecha · correos 1 día |
...
| 3 | **Copias de seguridad y registro de accesos** | El registro de accesos ya existe (D-042). Faltan las copias diarias (Neon las ofrece; hay que activarlas y probar una restauración). | 1 día |
